                                                        ...
                                                        <div class="col-xs-10 col-sm-12 col-md-12 col-xs-offset-2 col-sm-offset-0 col-md-offset-0 pad0lr">
                                                            ...
                                                            <div class="post-icons">
                                                                ...
                                                                <span>
                                                                    ...
                                                                    ?>
                                                                    <a href="<?php echo esc_url(get_day_link('', '', $archive_day)); ?>" class="icon"><i class="fa fa-calendar"></i> <?php echo esc_html(get_the_date());?></a>
                                                                </span>
                                                                <span>
                                        ...
                                        <div class="overlay-post-content">
                                            ...
                                            <div class="post-icons">
                                                ...
                                                <span>
                                                    ...
                                                    $archive_day   = get_the_time('d');
                                                    ?>
                                                    <a href="<?php echo esc_url(get_day_link('', '', $archive_day)); ?>" class="icon"><i class="fa fa-calendar"></i> <?php echo esc_html(get_the_date('M j, Y'));?></a>
                                                </span>
                                                <span>
                                                    <a href="<?php the_permalink(); ?>" class="icon">
                                                        <i class="fa fa-comment"></i> 
