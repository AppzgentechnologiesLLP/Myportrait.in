...
if( ! function_exists( 'emag_inline_style' ) ) :
    ...
    function emag_inline_style(){
        ...
        .page-inner-title .container {
         background-image: url(<?php echo esc_url($emag_banner_image);?>);
        }
        <?php 
        }

        $emag_custom_css = '';
        $emag_custom_css_output = '';
        if ( ! empty( $emag_custom_css ) ) {
            $emag_custom_css_output .= esc_textarea($emag_custom_css);
        }
        echo esc_textarea($emag_custom_css_output);/*escaping done above*/
        ?>
        </style>
    <?php
    }
