	...
	$wp_customize->add_control(
		new Total_Info_Text( 
			...
			array(
				...
				'description'	=> '<a class="ht-implink" href="http://demo.hashthemes.com/total/" target="_blank">'.__('Live Demo', 'total').'</a><a class="ht-implink" href="http://hashthemes.com/support/" target="_blank">'.__('Support Forum', 'total').'</a><a class="ht-implink" href="https://www.facebook.com/hashtheme/" target="_blank">'.__('Like Us in Facebook', 'total').'</a>',
			)
		)
	);
