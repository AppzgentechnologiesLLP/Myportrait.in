...
function total_scripts() {
	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/vendor/jquery.min.js');
	...
	wp_enqueue_style( 'total-style', get_stylesheet_uri(), array( 'animate'), '1.0' );
...
function total_admin_scripts($hook) {
	if( $hook == 'post.php' || $hook == 'widget.php' ){
		wp_enqueue_style( 'total-admin-style', get_template_directory_uri() . '/inc/css/admin-style.css', array(), '1.0' );
	}

	if($hook == 'widget.php'){
		wp_enqueue_media();
		wp_enqueue_script( 'total-admin-scripts', get_template_directory_uri() . '/inc/js/admin-scripts.js', array('jquery'), '20160915', true );
	}
}
...
function my_scripts_enqueue() {
    //wp_enqueue_script( 'script', get_template_directory_uri() . '/js/vendor/jquery.min.js', array ( 'jquery' ), 1.1, true);
   // wp_enqueue_script( 'script', '//code.jquery.com/jquery-1.11.3.min.js');
    wp_enqueue_style('bootstrap-css',get_template_directory_uri().'/bootstrap/css/bootstrap.min.css');
    wp_register_style( 'default-css', get_template_directory_uri() . '/css/custom/default.css', array(), '0.0.1','all' );
    //wp_enqueue_script('bootstrap-js',get_template_directory_uri().'/bootstrap/js/tether.min.js');
    ...
    wp_enqueue_script('bootstrap-js',get_template_directory_uri().'/bootstrap/js/bootstrap.min.js');
    wp_enqueue_script('default-js',get_template_directory_uri().'/js/custom/default.js',array(), '0.0.1','all');
